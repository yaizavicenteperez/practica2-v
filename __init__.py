...
defs = Definitions(
    assets=[
        ...
        # Transformaciones sin codislas
        islas_agregadas_data,
        datos_estructura_isla_2023,
        datos_evolucion_temporal,

        # Transformaciones con codislas
        municipios_data,
        renta_con_isla,
        datos_boxplot_temporal,
        datos_heatmap_tenerife,

        # Transformaciones con estudios
        datos_educacion_procesados,
        datos_educacion_renta,

        # Visualizaciones sin codislas
        viz_estructura_isla_2023,
        viz_evolucion_temporal,

        # Visualizaciones con codislas
        viz_boxplot_temporal,
        viz_heatmap_tenerife,
